...
public class ClientesView extends JPanel {
    ...
    public ClientesView() {
        ...
        // Estilização dos botões com as cores do Golden State Warriors
        cadastrar.setBackground(new Color(0, 56, 168)); // Azul
        editar.setBackground(new Color(253, 185, 39));  // Amarelo
